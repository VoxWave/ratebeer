...
class BeerClubsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer_club" do
    assert_difference('BeerClub.count') do
      post beer_clubs_url, params: { beer_club: { founded: @beer_club.founded, name: @beer_club.name } }
    end
  ...
  test "should update beer_club" do
    patch beer_club_url(@beer_club), params: { beer_club: { founded: @beer_club.founded, name: @beer_club.name } }
